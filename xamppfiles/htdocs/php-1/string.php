...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "Jumlah kata di kalimat pertama: ". str_word_count($first_sentence). "<br><br>  ";

        echo "Kalimat kedua: ". $second_sentence. "<br>";
        echo "Panjang string kalimat kedua: ". strlen($second_sentence). "<br>";
        echo "Jumlah kata di kalimat kedua: ". str_word_count($second_sentence). "<br>";
        ...
        */
        ...
        echo "String replace : \"".str_replace("sexy","awesome",$string3)."\"<br>";
